...
var Game = {
  ...
  m_downToBaseInterval : 0, //private long downToBaseInterval = 0;
	...
	GetPlayingTime : function (totalTime) {
    ...
    var str = totalTime - Game.m_cumulativeTime;
    if(str <= 0){
      Game.Stop();
    }
    console.log(str)
	...
	DownThread : function () {
		...
		Game.m_downTimer = setTimeout("Game.DownThread()", interval);
	},
