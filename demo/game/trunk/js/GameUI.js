...
var GameUI = {
	...
	FLASH_BTN_CLASS : "hover",
	
	NEW_GAME_STR : "新游戏",
	PAUSE_STR : "暂停",
	RESUME_STR : "继续",
	NOT_RESUME_STR : "<del>继续</del>",
	MUTE_STR : "静音",
	NOT_MUTE_STR : "<del>静音</del>",
	HELP_STR : "帮助",
	RANK_STR : "排行榜",
	BACK_STR : "返回",
	...
	flashButton : function (btnObj, loop) {
		...
		setTimeout("GameUI.removeBtnActive()", 350);
	},
	
	loopFlash : function () {
		GameUI.m_curActiveBtn.addClass(GameUI.FLASH_BTN_CLASS);
		setTimeout("GameUI.removeBtnActive()", 400);
	},
    ...
    console.log('getRank')
		...
		// 		"time" : time
		// 	}, function (data) {
		// 		GameUI.m_lastRank = parseInt(data);
		// 		$(".currentRank").html(GameUI.m_lastRank);
    //   });
    console.log(score, level, time)
      GameUI.getResult("current");
	},
    ...
    console.log('getResult')
		...
		// 		});
		// } else {
		// 	rankList.html('<li id="list1"><div class="name">姓名<div class="gameRank">Score: <span class="currentRank">23000</span></div></div></li>');
		// 	$("#rankList ul").fadeIn();
    // }
    
    switch(target){
      case 'current':
        rankList.html('<li id="list1"><div class="name">current<div class="gameRank">Score: <span class="currentRank">23000</span></div></div></li>');
        break;
      case 'total':
        rankList.html('<li id="list1"><div class="name">total<div class="gameRank">Score: <span class="currentRank">23000</span></div></div></li>');
        break;
      case 'best':
        rankList.html('<li id="list1"><div class="name">best<div class="gameRank">Score: <span class="currentRank">23000</span></div></div></li>');
        break;
    }
		$("#rankList ul").fadeIn();
	...
	paint : function () {
		...
		if (!GameUI.m_game.isEffecting()) {
			...
			// Time
			GameUI.m_divTime.html(GameUI.m_game.GetPlayingTime(50));
		}
	},
	...
	dispearLinesEffect : function (queue, beforeDispear, afterAni) {
		...
		GameUI.m_aniCount = 0;
		GameUI.m_timer = setTimeout("GameUI.aniDis()", GameUI.ANI_INTERVAL);
	},
